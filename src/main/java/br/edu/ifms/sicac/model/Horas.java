...
public class Horas implements Serializable{
	...
	@JoinColumn(name="validacaoHoras_id")
	@ManyToOne
	private ValidacaoHoras validacaoHoras;
	...
	public ValidacaoHoras getValidacaoHoras() {
		return validacaoHoras;
	}
	public void setValidacaoHoras(ValidacaoHoras validacaoHoras) {
		this.validacaoHoras = validacaoHoras;
	}
	@Override
	public int hashCode() {
